...
int CheckInputLeft(); // Проверка на ввод левовых элементов списка
...
int main() 
{
	...
	cout << "|| Данная программа запрашивает данные для двойного списка с односторонней связь, ||"
