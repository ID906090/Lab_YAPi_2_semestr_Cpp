...
int** enterMatrices(int** matrix, int sizeArr); //Ввод матриц

void cleanMatrices (int** matrix, int sizeArr); //Очистка матрицы в функции enterMatrices
...
int** enterMatrices(int** matrix, int sizeArr) //Матрицы размером i, j --> matrix[i][j], где i - строка, j - столбец
{
...
void cleanMatrices (int** matrix, int sizeArr)
{
    for (int value = 0; value < sizeArr; value++) delete[]matrix[value];
    delete[]matrix;
}
